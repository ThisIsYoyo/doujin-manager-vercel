...
import { DataGrid, GridColDef, MuiBaseEvent, MuiEvent } from "@mui/x-data-grid";
import React, { Suspense } from "react";
import { useEffect, useState } from "react";
import { Loading } from "../Loading/Loading";
import { AuthorType } from "./Author.type";
import { AuthorAddModal } from "./modal/AuthorAddModal";
import { AuthorDeleteModal } from "./modal/AuthorDeleteModal";

const URL = `${window.location.origin}/api/doujin/author/list/`;
const EDIT_URL = `${window.location.origin}/api/doujin/author/`;
