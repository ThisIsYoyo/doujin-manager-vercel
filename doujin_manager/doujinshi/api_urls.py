...
urlpatterns = [
    ...
    re_path(r"^circle/(?P<id>\d+)/", view=views.CircleGETView.as_view(), name="circle get/modify by id"),
    re_path(r"^author/(?P<id>\d+)/", view=views.AuthorGETView.as_view(), name="author get/modify by id"),
    re_path(r"^doujinshi/(?P<id>\d+)/", view=views.DoujinshiGETView.as_view(), name="doujinshi get/modify by id"),
    # create data
